  ...
  <div class="app-container">
    ...
    <div class="search-div">
      <el-form label-width="70px" size="small" label-position="left">
        <el-row>
          <el-col :span="8">
            <el-form-item label="实验室名称：" label-width="30%">
              <el-input v-model="reserveCondition.labName" style="width: 60%" placeholder="实验室名称" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="选择日期：" label-width="30%">
              <el-date-picker
                default-value="reserveCondition.reserveDate"
                v-model="reserveCondition.reserveDate"
                type="date"
                placeholder="选择日期">
              </el-date-picker>
            </el-form-item>
...
export default {
  data() {
    return {
      ...
      reserveCondition: pageCondition // 查询条件
