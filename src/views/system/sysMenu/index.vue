  ...
  <div class="app-container">
    ...
    <el-dialog :title="dialogTitle" :visible.sync="dialogVisible" width="40%">
      <el-form ref="dataForm" :model="sysMenu" label-width="150px" size="small" style="padding-right: 40px;">
        ...
        <el-form-item v-if="sysMenu.type !== 0 && sysMenu.type!== 2" prop="path">
          <span slot="label">
...
export default {
  ...
  methods: {
     ...
     */
    changeStatus(data) {
      this.sysMenu = Object.assign({}, data)
      this.sysMenu.status = data.status
    }
  }
}
</script>
